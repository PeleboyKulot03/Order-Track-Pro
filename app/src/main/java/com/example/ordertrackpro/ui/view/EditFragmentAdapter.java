...
public class EditFragmentAdapter extends RecyclerView.Adapter<EditFragmentAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public EditFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.menu_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EditFragmentAdapter.ViewHolder holder, int position) {
