...
import com.example.ordertrackpro.utils.EditModel;
...
public class EditRecyclerViewAdapter extends RecyclerView.Adapter<EditRecyclerViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public EditRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.edit_item_card, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EditRecyclerViewAdapter.ViewHolder holder, int position) {
